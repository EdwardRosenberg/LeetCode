...
| [Minimum Window Substring](https://leetcode.com/problems/minimum-window-substring/) | Hard | smallest window of text that contains every character of pattern (counts included) | [MinimumWindowSubstring.md](minimumwindowsubstring/MinimumWindowSubstring.md) | 2026-08-02 |
